package com.isomer.ec.explorecali.web;


import com.isomer.ec.explorecali.domain.Tour;
import com.isomer.ec.explorecali.domain.TourRating;
import com.isomer.ec.explorecali.domain.TourRatingPk;
import com.isomer.ec.explorecali.repo.TourRatingRepository;
...
public class TourRatingController {
    ...
    private void verifyTour(String tourId) throws NoSuchElementException {
        if (!tourRepository.existsById(Integer.valueOf(tourId))) {
